<?php
// Описание: RegEx search and replace.
// Источник: https://github.com/sciactive/2be-extras/blob/master/sandbox/hperrin/regex-search-replace.php



// нужен полный путь: /var/www/test-sergei/data/www/thepuretaste-test.u.org.ua/search -  а не /www/thepuretaste-test.u.org.ua/search

/* 
$_REQUEST['q'] = 'search';
$_REQUEST['base_dir'] = '/www/thepuretaste-test.u.org.ua/search/';
$_REQUEST['pattern'] = '*.txt';
$_REQUEST['search'] = '\[class\^="icon-"\].*\.icon-fullscreen.*?\}\n';
$_REQUEST['replace'] = ''; 
$_REQUEST['per_file_limit'] = ''; 
$_REQUEST['mod_i'] = false;
$_REQUEST['mod_m'] = false;
$_REQUEST['mod_s'] = false;
*/


ini_set('error_reporting', E_ERROR);  // или  то
//ini_set('error_reporting', E_ALL);  // или это
...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="https://current.bootstrapcdn.com/bootstrap-v204/css/bootstrap-responsive.css" />
